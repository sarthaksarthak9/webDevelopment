// Shery.imageEffect("#back", {style: 5, debug: true, gooey: true})   // Shery.imageEffect(element, configuration)
...
"aspect":{"value":1.7711662502179093},"ignoreShapeAspect":{"value":true},
...
"onMouse":{"value":1},"noise_speed":{"value":0.2,"range":[0,10]},"metaball":{"value":0.175,"range":[0,2],
"_gsap":{"id":3}},"discard_threshold":{"value":0.6,"range":[0,1]},
"antialias_threshold":{"value":0,"range":[0,0.1]},"noise_height":{"value":0.23,"range":[0,2]},
"noise_scale":{"value":20.61,"range":[0,100]}}, 
gooey: true})   // Shery.imageEffect(element, configuration)

var elems = document.querySelectorAll(".elem");

elems.forEach(function(elem){
    var h1s = elem.querySelectorAll("h1"); /*elem because we are doing for selected text not the document*/
    var index = 0;
    var animating = false;
    ...
    document.querySelector("#main").addEventListener("click", function(){
     ...
     if(!animating){
            animating = true;
            gsap.to(h1s[index],{
                top: "-=100%",     /*so that text(top element) move upward*/
                ease: Expo.easeInOut,
                duration: 1,
                onComplete: function(){
            ...
            gsap.to(h1s[index],{
                top: "-=100%",     /*so that text(bottom element) move upward*/
                ease: Expo.easeInOut,
                duration: 1,
            });  
        }   
